...
switch_config = SwitchDataParser::Regexp::Config.parse(IO.readlines(File.join(DATA_DIR, "switch.config")))
bridge_table  = SwitchDataParser::Regexp::BridgeTable.parse(IO.readlines(File.join(DATA_DIR, "bridge_table.config")))
